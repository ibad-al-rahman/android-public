...
class PrayerTimesSmallWidgetProvider: AppWidgetProvider() {
    ...
    private fun getLocalizedPrayerName(context: Context, prayerName: String): String {
        return when (prayerName) {
            PrayerTimesWidgetViewModel.Prayer.FAJR.name -> context.getString(com.ibadalrahman.resources.R.string.fajr)
            PrayerTimesWidgetViewModel.Prayer.SUNRISE.name -> context.getString(com.ibadalrahman.resources.R.string.sunrise)
            PrayerTimesWidgetViewModel.Prayer.DHUHR.name -> context.getString(com.ibadalrahman.resources.R.string.dhuhr)
            PrayerTimesWidgetViewModel.Prayer.ASR.name -> context.getString(com.ibadalrahman.resources.R.string.asr)
            PrayerTimesWidgetViewModel.Prayer.MAGHRIB.name -> context.getString(com.ibadalrahman.resources.R.string.maghrib)
            PrayerTimesWidgetViewModel.Prayer.ISHAA.name -> context.getString(com.ibadalrahman.resources.R.string.ishaa)
            else -> prayerName
        }
    }
